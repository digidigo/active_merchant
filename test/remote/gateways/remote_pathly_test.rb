...
# 5488888888888888, 9000100111111111 for success,

# 5413131313131313, 4929123123123 for fail,

# 9000100811111111 for 3DS verification.
...
class RemotePathlyTest < Test::Unit::TestCase
  def setup
    ...
    @amount = 100
    @credit_card = credit_card('5488888888888888')
    @declined_card = credit_card('5413131313131313')
    @options = {
