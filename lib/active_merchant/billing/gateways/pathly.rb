...
module ActiveMerchant #:nodoc:
  module Billing #:nodoc:
    class PathlyGateway < Gateway
      ...
      self.homepage_url = 'https://www.pathly.io/'
      ...
      def add_payment(post, payment, options)
        ...
        post[:initial_transaction_id] = options[:initial_transaction_id] if options[:initial_transaction_id] # Pathly initial transaction id
      ...
      def standard_request_headers
        {
          ...
          Authorization: options[:api_ksey],
